...
namespace Russell_Peake_Project
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Initialize()
        {
            ...
            Follow = new Camera(this, new Vector3(5, 5, 0), MathHelper.ToRadians(70f), MathHelper.ToRadians(20f));
            ...
            MiniMap = new Camera(this, new Vector3(0, 0, 5f), MathHelper.ToRadians(90f), -MathHelper.ToRadians(90f));
