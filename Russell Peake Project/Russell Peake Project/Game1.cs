...
namespace Russell_Peake_Project
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Initialize()
        {
            ...
            MiniMap = new Camera(this, new Vector3(0, 0, 10f), MathHelper.ToRadians(90f), -MathHelper.ToRadians(90f));
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (!pause || step)
            {
                ...
                Follow.Position = machine.TrackedObject.Location - (direction * 2f);
