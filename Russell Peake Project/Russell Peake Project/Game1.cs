...
namespace Russell_Peake_Project
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Initialize()
        {
            ...
            AlternateProjectionMatrix = Matrix.CreatePerspectiveFieldOfView(MathHelper.ToRadians(150f), GraphicsDevice.Viewport.AspectRatio, 0.01f, 100.0f);
            ...
            MiniMap = new Camera(this, new Vector3(0, 0, 25f), MathHelper.ToRadians(90f), -MathHelper.ToRadians(90f));
